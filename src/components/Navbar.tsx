            ...
            <div className="max-w-6xl mx-auto px-4 py-3 flex items-center justify-between">
                ...
                <div className="flex items-center gap-3">
                    ...
                    <button
                        ...
                        className="flex items-center gap-2 bg-[#25D366] hover:bg-[#20BD5A] text-white px-5 py-2.5 rounded-2xl font-semibold transition-all duration-300 hover:scale-105 shadow-lg shadow-green-200 hover:shadow-green-300"
                    >
